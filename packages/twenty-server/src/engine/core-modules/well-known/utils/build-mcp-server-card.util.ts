...
export const buildMcpServerCard = ({
  ...
  title: 'Jai OS CRM',
  description:
    'Read and write your Jai OS CRM data - companies, people, opportunities, tasks, notes and any custom objects - from AI assistants. Tools are discovered at runtime and scoped to the authenticated workspace.',
